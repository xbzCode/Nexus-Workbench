...
--tools	限制可用的内置工具集（白名单）。空字符串 "" 禁用所有内置工具，"default" 使用全部工具，或指定逗号分隔的工具名	codebuddy --tools "Bash,Read,Edit"
...
--permission-mode	以指定的权限模式开始	codebuddy --permission-mode plan
--subagent-permission-mode	设置 subagent/团队成员的默认权限模式，覆盖从主 session 继承的模式	codebuddy --subagent-permission-mode bypassPermissions
