...
--allowedTools	允许的工具列表,空格分隔或

逗号分隔的字符串	codebuddy --allowedTools mcp__slack mcp__filesystem

codebuddy --allowedTools "Bash(npm install),mcp__filesystem"
--disallowedTools	拒绝的工具列表,空格分隔或

逗号分隔的字符串	codebuddy --disallowedTools mcp__splunk mcp__github
